...
setInterval(showSaveSyncToastMessage('saveReminder', 'save', 1), document.getElementById('saveReminder').options[document.getElementById('saveReminder').selectedIndex].value * 60000);
