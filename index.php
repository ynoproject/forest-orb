        ...
        <div id="gameContainer">
          <div id="controls">
            ...
            <div id="leftControls">
              ...
              </button><?php if ($gameId == "2kki"): ?><button id="explorerButton" style="display: none" class="iconButton toggleButton onToggleButton desktopOnly accountRequired unselectable" data-i18n="[title]tooltips.toggleExplorer">
